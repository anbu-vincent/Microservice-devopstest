package com.devopstest.auth.config;
...
/**
 * JKS Generation
 * keytool -genkeypair -alias devopstesttest -keyalg RSA -keypass devopstestpass -keystore devopstesttest.jks -storepass devopstestpass
 * keytool -list -rfc --keystore devopstesttest.jks | openssl x509 -inform pem -pubkey
...
class OAuth2AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtTokenEnhancer() {
        ...
        final KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(
                new ClassPathResource("devopstesttest.jks"), "devopstestpass".toCharArray());
        converter.setKeyPair(keyStoreKeyFactory.getKeyPair("devopstesttest"));
        return converter;
    }
